...
// find the numbers within the strings that are written using letters
...
for (let i = 1; i < myArray.length; i++) {
  let num = getFirstDigit(myArray[i]) + getLastDigit(myArray[i]);

  sumAll += parseInt(num);
}
// -----------------------------
console.log("The sum of all values is: " + sumAll);
